...
class AppColors extends ThemeExtension<AppColors> {
  ...
  static const light = AppColors(
    windowBg: Color(0xFFEEEFF2),
    surface: Color(0xFFFFFFFF),
    surfaceSubtle: Color(0xFFF2F3F5),
    surfaceHover: Color(0xFFE8EAEE),
    border: Color(0xFFDEE1E6),
    borderStrong: Color(0xFFC6CAD2),
    ...
    accentSubtle: Color(0xFFEBECFC),
    selectedInactive: Color(0xFFE4E6EB),
  ...
  static const dark = AppColors(
    windowBg: Color(0xFF16171A),
    surface: Color(0xFF212226),
    surfaceSubtle: Color(0xFF26272C),
    surfaceHover: Color(0xFF2E3036),
    border: Color(0xFF33353C),
    borderStrong: Color(0xFF484B53),
    ...
    selectedInactive: Color(0xFF33353C),
